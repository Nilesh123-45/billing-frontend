...
const ItemForm = () => {
    ...
    const onChangeHandler = (e) => {
        ...
        setData((prevData) => ({
 ...prevData, // Use the 'prevData' you were given
 [name]:value
 }));
        // setData((data) => ({
        //     ...data,
          ...
          setCategories((prevCategories) =>
            prevCategories.map((category) => {
              if (category.categoryId === data.categoryId) {
                // Check if 'items' exists and is a number, otherwise default to 0
                const currentItemCount = (typeof category.items === 'number' ? category.items : 0);
                
                return { 
                  ...category, 
                  items: currentItemCount + 1 
                };
              }
              return category;
            })
